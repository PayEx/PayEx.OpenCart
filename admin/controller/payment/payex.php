                ...
                switch ($this->request->post['action']) {
                    case 'capture':
                        ...
                        $this->model_sale_order->addOrderHistory($order_id, array(
                            'order_status_id' => $this->data['payex_completed_status_id'],
                            'notify' => true,
                            'comment' => ''
                        ));
                    ...
                    case 'cancel':
                        ...
                        // Set Order Status
                        $this->model_sale_order->addOrderHistory($order_id, array(
                            'order_status_id' => $this->data['payex_canceled_status_id'],
                            'notify' => false,
                            'comment' => ''
                        ));
                    ...
                    case 'refund':
                        ...
                        // Set Order Status
                        $this->model_sale_order->addOrderHistory($order_id, array(
                            'order_status_id' => $this->data['payex_refunded_status_id'],
                            'notify' => false,
                            'comment' => ''
                        ));
