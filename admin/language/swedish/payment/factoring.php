...
$_['heading_title'] = 'PayEx Factoring';
$_['text_payment'] = 'Payment';
$_['text_factoring'] = '<a href="http://payex.com/" target="_blank"><img src="view/image/payment/payex_factoring.gif" alt="PayEx Factoring" title="PayEx Factoring" style="border: 1px solid #eee;" /></a>';
$_['text_success'] = 'Success: PayEx Factoring settings saved.';
